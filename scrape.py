...
urls = ["https://in.finance.yahoo.com/quote/GOOG?p=GOOG&.tsrc=fin-srch", "https://in.finance.yahoo.com/quote/AMZN?p=AMZN&.tsrc=fin-srch", "https://in.finance.yahoo.com/quote/MSFT?p=MSFT&.tsrc=fin-srch"]
...
csv_writer.writerow(['Stock Name', 'Current Price', 'Previous Close', 'Open', 'Bid', 'Day Range', '52 Week Range', 'Volume', 'Avg. Volume'])
